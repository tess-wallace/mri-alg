function twix_obj = mapVBVD_v2(filename,varargin)
...
for s=1:NScans
    ...
    rstraj = [];
    if arg.bReadHeader
        [twix_obj{s}.hdr,rstraj] = read_twix_hdr_v2(fid);
    end

    % declare data objects:
    twix_obj{s}.image         = twix_map_obj_v2(arg,'image',filename,version,rstraj);
    twix_obj{s}.noise         = twix_map_obj_v2(arg,'noise',filename,version);
    twix_obj{s}.phasecor      = twix_map_obj_v2(arg,'phasecor',filename,version,rstraj);
    twix_obj{s}.phasestab     = twix_map_obj_v2(arg,'phasestab',filename,version,rstraj);
    twix_obj{s}.phasestabRef0 = twix_map_obj_v2(arg,'phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.phasestabRef1 = twix_map_obj_v2(arg,'phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.refscan       = twix_map_obj_v2(arg,'refscan',filename,version,rstraj);
    twix_obj{s}.refscanPC     = twix_map_obj_v2(arg,'refscan_phasecor',filename,version,rstraj);
    twix_obj{s}.refscanPS     = twix_map_obj_v2(arg,'refscan_phasestab',filename,version,rstraj);
    twix_obj{s}.refscanPSRef0 = twix_map_obj_v2(arg,'refscan_phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.refscanPSRef1 = twix_map_obj_v2(arg,'refscan_phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.RTfeedback    = twix_map_obj_v2(arg,'rtfeedback',filename,version,rstraj);
    twix_obj{s}.vop           = twix_map_obj_v2(arg,'vop',filename,version); % tx-array rf pulses
